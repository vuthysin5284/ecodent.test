      ...
      buttons: [{
        ...
        },
        {
          ...
          buttons: [
            ...
            { text: 'Impression', action: function (e, dt, node, config) { _num_code = 'Impression'; _table.ajax.reload(); } },
            { text: 'Luting Cement', action: function (e, dt, node, config) { _num_code = 'Luting Cement'; _table.ajax.reload(); }},
            { text: 'Orthodontics', action: function (e, dt, node, config) { _num_code = 'Orthodontics'; _table.ajax.reload(); } },
            { text: 'Endodontic', action: function (e, dt, node, config) { _num_code = 'Endodontic'; _table.ajax.reload(); }},
            { text: 'Material', action: function (e, dt, node, config) { _num_code = 'Material'; _table.ajax.reload(); }}, 
          ]
        },{
          extend: 'collection',
          className: 'dropdown-toggle btn btn-label-secondary shadow-none',
