  ...
  $('#dataTable').on('click', '.editBtn', function() {   
    ...
    $.ajax({
      ...
      success : function(data) {
        var json = JSON.parse(data);
        $('#id').val(json.id);
        $('#menuCategory').val(json.menu_id);
        $('#menuName').val(json.sub_menu_name);
        $('#menuKh').val(json.sub_menu_kh);
        $('#menuUrl').val(json.sub_menu_link);
        $('#menuOrder').val(json.sub_menu_order);
      }
    });
  });
