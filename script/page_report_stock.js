  ...
  function getDataReport(str) {
    $.ajax({
      url : '../data/query_report_stock.php',
      type : 'POST',
      data : {
        qid : 2,
        date : $('#date').val(),
  ...
  function getDataTable() {
    $('#dataTable').DataTable({  
      ...
      buttons: [{
        ...
        buttons: [
          { extend: 'print', text: '<i class="bx bx-printer me-2"></i>Print', className: "dropdown-item", exportOptions: {columns:[0,2,3,4,5,6]} },
          { extend: 'excelHtml5', text: '<i class="bx bx-file me-2"></i>Excel', className: "dropdown-item", exportOptions: {columns:[0,2,3,4,5,6]} },
          { extend: 'copyHtml5', text: '<i class="bx bx-copy me-2"></i>Copy', className: "dropdown-item", exportOptions: {columns:[0,2,3,4,5,6]} },
