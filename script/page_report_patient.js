  ...
  function getDataReport(str) {
    $.ajax({
      url : '../data/query_report_patient.php',
      type : 'POST',
      data : {
        qid : 2,
        date : $('#date').val(),
    ...
    $('#dataTable').DataTable({  
      ...
      buttons: [{
        ...
        buttons: [
          ...
          { extend: 'excelHtml5', text: '<i class="bx bx-file me-2"></i>Excel', className: "dropdown-item", exportOptions: {columns:[0,2,3,4,5,6,7,8,9]} },
          { extend: 'copyHtml5', text: '<i class="bx bx-copy me-2"></i>Copy', className: "dropdown-item", exportOptions: {columns:[0,2,3,4,5,6,7,8,9]} },
      ...
      aoColumnDefs: [
        { bSortable: false, aTargets: [1,7,8] },
