...
>
  ...
  <foot>
    ...
    <script src="../script/page_invoice_draft.js"></script>
    <script type="text/javascript">
      window.onload = function(){
        var activeMenu = document.getElementById("Revenues");
        activeMenu.classList.add("open");
        activeMenu.classList.add("active");
        // var activeSubMenu = document.getElementById("Draft Invoice");
        // activeSubMenu.classList.add("active");
        var activeSubMenu = document.getElementById("Quotation List");
        activeSubMenu.classList.add("active");
      };
    </script>
  </foot>
