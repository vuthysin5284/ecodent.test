                  ...
                  <div class="card">
                    ...
                    <div class="card-body">  
                      <div class="card-header d-flex align-items-center justify-content-between"> 
                        ...
                        <div class="dropdown">
                          <button class="btn btn-warning p-2" type="button" id="transactionID" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="bx bx-dots-vertical-rounded"> Make Change User Login </i> 
                          </button>
    ...
    <script type="text/javascript">
      window.onload = function(){
        ...
        activeMenu.classList.add("active"); 
          ...
          // active tab 
          var activeTabMenu = document.getElementById("staff-permission");
