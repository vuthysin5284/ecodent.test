      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-12 p-6">
          <div class="w-px-400 mx-auto">
            ...
            <p class="mb-6">Make your dental management easy and fun!</p>

            <form id="formBusinessRegistration" class="mb-6" method="POST" enctype="multipart/form-data">
              <div class="mb-6">
                ...
                <input
                  ...
                  id="name"
                  name="name"
                  placeholder="Asia Dental Clinic"
                  required
                  autofocus />
              </div>

              <div class="mb-6">
                <label for="slug" class="form-label">Subdomain Name <span class="text-danger">*</span></label>
                <div class="input-group input-group-merge">
                  <input
                    ...
                    id="slug"
                    name="slug"
                    placeholder="asiadental"
                    required/>
                  <span class="input-group-text" id="basic-addon13">.dentalize.app</span>
                </div>
                <p class="text-danger mt-3" id="slug-status"></p>
              </div>
              ...
              <button class="btn btn-primary d-grid w-100">Create Business</button>
            </form>
