...
>
  <head>
    <?php 
      if ($lang == 1) {
        ...
        $page_title = 'Staff Position';
        $text_btn_create = 'New';
        $text_form = 'Staff Position';
        $m1 = 'Position ID';
        $m2 = 'Position';
        $m3 = 'Default Permission';
        $th2 = 'Position';
        $th3 = 'Default Permission';
        $th4 = 'Action';
      } else {
        $page_category = 'បុគ្គលិក';
        $page_title = 'តួនាទីបុគ្គលិក';
        $text_btn_create = 'បង្កើតថ្មី';
        $text_form = 'តួនាទីបុគ្គលិក';
        $m1 = 'លេខកូដ';
        $m2 = 'តួនាទី';
        $m3 = 'ការអនុញ្ញាត';
        $th2 = 'តួនាទី';
                ...
                <div class="modal-dialog">
                  <form class="modal-content" id="addForm" method="POST" enctype="multipart/form-data"> 
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row mb-3"><?php echo inpText($m2, 'name', 'Ex: Dental Assistant'); ?></div>
                      <div class="row mb-3"><?php echo inpText($m3, 'permission', 'Ex: 1, 2, 3, 4, 5, 6, 7, 8, 10'); ?></div>
                    </div>
  ...
  <foot>
    ...
    <script src="../script/page_staff_position.js"></script>
    <script type="text/javascript">
      window.onload = function(){
          var activeMenu = document.getElementById("Employee List");
          activeMenu.classList.add("open");
          activeMenu.classList.add("active");
          var activeSubMenu = document.getElementById("Position");
