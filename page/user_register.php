      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-12 p-6">
          <div class="w-px-400 mx-auto">
            ...
            <form id="formUserRegistration" class="mb-6" method="POST" enctype="multipart/form-data">
              <div class="mb-6">
                <input
                  type="text"
                  class="form-control"
                  ...
                  name="token"
                  placeholder="Token"
                  value="<?php echo isset($_GET['token']) ? $_GET['token'] : null?>"
                  required/>
              </div>
              <div class="row mb-6">
                <div class="col">
                ...
                <div class="col">
                  <label for="last_name" class="form-label">First Name <span class="text-danger">*</span></label>
                  <input
                    type="text"
                    class="form-control"
                    id="last_name"
              ...
              <div class="mb-6 form-password-toggle">
                ...
                <p class="text-danger mt-3" id="password_status"></p>
              </div>
              <button class="btn btn-primary d-grid w-100">Create Account</button>
            </form>
