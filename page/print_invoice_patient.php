  ...
  <body  >
    ...
    <div class="invoice-wrapper">
      <div class="invoice-container position-relative">
        <header class="mb-0">
          <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="text-body">
              ...
              <h5 class="text-center fw-bolder" style="color : #000;"><?=$rowt["system_name_en"]?></h5>
            </div>
          ...
          <div class="d-flex align-items-center justify-content-between" style="margin:10px">
            <span> </span>
            <div class="text-body">
              <h5 class="text-center"><?=$rowt["address"]?></h3>
              <h5 class="text-center"><?=$rowt["phone"]?></h5>
            </div> 
            <span> </span>
          </div>
        ...
        <hr class="me-0">
        <h4 class="text-center text-dark fw-bolder mb-2 mt-4"><?php echo ($pmid>0?"បង្កាន់ដៃ":"វិក្ក័យបត្រ"); ?></h4>
        <h5 class="text-center text-dark fw-bold"><?php echo ($pmid>0?"RECEPT":"INVOICE"); ?></h5>
        <main>
          <div class="row mb-2">
            <div class="col-12">
              <table class="table table-bordered text-dark">
                <thead class="text-nowrap table-secondary">
                  <tr>
                    ...
                    <th class="text-center text-dark fw-bolder">លេខធ្មេញ</th>
          ...
          <p class="text-body text-center" style="font-size:13px"><?=$rowt["remark_invoice"]?></p>
        </main> 
        <footer class=" bottom-0 pb-3" style="width : 100%;"> 
          <div class="row">
