...
<html
  ...
  <body>
    ...
    <div class="authentication-wrapper authentication-cover">
      <!-- Logo -->
      <a href="index.php" class="app-brand auth-cover-brand gap-2">
        ...
        <span class="app-brand-text demo text-heading fw-bold">ecodent</span>
      </a>
      <!-- /Logo -->
      <div class="authentication-inner row m-0">
        ...
        <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg p-sm-12 p-6">
          <div class="w-px-400 mx-auto">
            <h4 class="mb-1">Your trustly management clinic information</h4>
            <p class="mb-6">Welcome to ecodent practic management</p>

            <form id="loginForm" class="mb-6" method="POST" enctype="multipart/form-data" role="form">
              <div class="mb-6">
