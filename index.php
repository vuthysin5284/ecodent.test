...
<html
  ...
  <head>
    ...
    <title>ecodent practic management tracking</title>
      ...
      <div class="container">
        <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
          ...
          <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <!-- navbar button: Start -->
            <li>
              <a href="page/login.php" class="btn btn-primary me-2" target="_parent"
                ><span class="tf-icons bx bx-log-in-circle scaleX-n1-rtl me-md-1"></span
                ><span class="d-none d-md-block">Login</span></a
              >
            </li>
						<li>
              <a href="page/register.php" class="btn btn-primary" target="_parent"
                ><span class="tf-icons bx bx-log-in-circle scaleX-n1-rtl me-md-1"></span
                ><span class="d-none d-md-block">Sign Up</span></a
              >
            </li>
            <!-- navbar button: End -->
          </ul>
