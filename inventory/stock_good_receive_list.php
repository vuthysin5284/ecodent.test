...
>
  <head>
    <?php 
      if ($lang == 1) {
        ...
        $page_title = 'Goods Receive List';
        $text_btn_create = 'Make Goods Receive';
          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- <div class="modal fade" id="Modal" data-bs-backdrop="static" tabindex="-1">
                ...
                <div class="offcanvas offcanvas-end" style="--bs-offcanvas-width: 800px;" tabindex="-1" id="goodreceiveOffcanvas" 
                  aria-labelledby="goodreceiveOffcanvasLabel"> 
                  <div class="offcanvas-header">
                      <h5 class="offcanvas-title" id="goodreceiveOffcanvasLabel"><?php echo $text_form; ?></h5>
  ...
  <foot>
    ...
    <script src="script/page_goods_receive_list.js"></script>
    <script type="text/javascript">
      window.onload = function(){
          var activeMenu = document.getElementById("Inventory");
          activeMenu.classList.add("open");
          activeMenu.classList.add("active");
          var activeSubMenu = document.getElementById("sub-Good Receive");
