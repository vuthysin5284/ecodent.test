          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- <div class="modal fade" id="Modal" data-bs-backdrop="static" tabindex="-1">
                ...
                <div class="offcanvas offcanvas-end" style="--bs-offcanvas-width: 800px;" tabindex="-1" id="supplierOffcanvas" 
                  aria-labelledby="supplierOffcanvasLabel"> 
                  <div class="offcanvas-header">
                      <h5 class="offcanvas-title" id="supplierOffcanvasLabel"><?php echo $text_form; ?></h5>
  ...
  <foot>
    ...
    <script type="text/javascript">
      window.onload = function(){
          ...
          var activeSubMenu = document.getElementById("sub-Supplier List");
