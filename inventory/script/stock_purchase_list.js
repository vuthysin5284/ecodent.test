...
$(document).on('click', '#create', function() {
    // Show the offcanvas
    const offcanvas = new bootstrap.Offcanvas(document.getElementById('purchaseorderOffcanvas'));
    offcanvas.show();
  // clearForm();
...
function getDataTable() {
  _table = $('#dataTable').DataTable({  
    ...
    buttons: [{
        ...
        text: 'Pending',
        action: function (e, dt, node, config) { _status = 'PENDING'; _table.ajax.reload(); }
      },{
        className: 'btn btn-primary',
        text: 'Ordering',
        action: function (e, dt, node, config) { _status = 'ORDERING'; _table.ajax.reload(); }
      },{
        className: 'btn btn-primary',
        text: 'Received',
        action: function (e, dt, node, config) { _status = 'RECEIVED'; _table.ajax.reload(); }
      },{
        className: 'btn btn-warning',
        text: 'Cancelled',
        action: function (e, dt, node, config) { _status = 'CANCELLED'; _table.ajax.reload(); }
      },{
        extend: 'collection',
