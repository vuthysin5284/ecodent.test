...
>
  <head>
    <?php 
      if ($lang == 1) {
        ...
        $text_btn_create = 'Make Order';
        $text_form = 'Inventory Information';
                ...
                <div class="modal-dialog" style="max-width: 95%;">
                  <form class="modal-content" id="addForm" method="POST" enctype="multipart/form-data"> 
                    <div class="modal-header">
                      <h5 class="modal-title" id="backDropModalTitle">Form Purchase Order</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div> 
                    <div class="modal-body">  -->
                <div class="offcanvas offcanvas-end" style="--bs-offcanvas-width: 800px;" tabindex="-1" id="purchaseorderOffcanvas" 
                  aria-labelledby="purchaseorderOffcanvasLabel"> 
                  <div class="offcanvas-header">
                      <h5 class="offcanvas-title" id="purchaseorderOffcanvasLabel"><?php echo $text_form; ?></h5>
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <table id="order_items-tbl" class="table table-striped table-bordered table-hover" width="100%">
                                        ...
                                        <tr id='1'>
                                            ...
                                            <td style='padding: 3px;text-align:center'><button type="button" onClick='onDelete(1);' class='btn btn-danger'><span class="tf-icons bx bx-trash"/></button></td>
                                        </tr>
                                        <tr id='2'>
                                            ...
                                            <td style='padding: 3px;text-align:center'><button type="button" onClick='onDelete(2);' class='btn btn-danger'><span class="tf-icons bx bx-trash"/></button></td>
                                        </tr>
                                        <tr id='3'>
                                            ...
                                            <td style='padding: 3px;text-align:center'><button type="button" onClick='onDelete(3);' class='btn btn-danger'><span class="tf-icons bx bx-trash"/></button></td>
                                        </tr>
                                        <tr id='4'>
                                            ...
                                            <td style='padding: 3px;'><input type='number' name="evening[]" min='0' value='1' style='text-align: center' class='form-control'/></td>
                                            <td style='padding: 3px;'><input type='number' name="duration[]" min='0' value='3' style='text-align: center' class='form-control'/></td>
                                            <td style='padding: 3px;text-align:center'><button type="button" onClick='onDelete(4);' class='btn btn-danger'><span class="tf-icons bx bx-trash"/></button></td>
                                        </tr>
                                        <tr id='5'>
                                            ...
                                            <td style='padding: 3px;'><input type='number' name="evening[]" min='0' value='1' style='text-align: center' class='form-control'/></td>
                                            <td style='padding: 3px;'><input type='number' name="duration[]" min='0' value='3' style='text-align: center' class='form-control'/></td>
                                            <td style='padding: 3px;text-align:center'><button type="button" onClick='onDelete(5);' class='btn btn-danger'><span class="tf-icons bx bx-trash"/></button></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="row" style="margin-top: 10px">
                                <div class="col-sm-12">
                                    <button type="button" class="btn btn-info add-row pull-right">Add Row</button> 
                                </div>
                            </div>
                        </div> 
  ...
  <foot>
    ...
    <script src="script/stock_purchase_list.js"></script>
    <script type="text/javascript">
      window.onload = function(){
          var activeMenu = document.getElementById("Inventory");
          activeMenu.classList.add("open");
          activeMenu.classList.add("active");
          var activeSubMenu = document.getElementById("sub-Purchase Order");
    ...
    $(document).ready(function(){ 
        $(".add-row").click(function(){
            var markup = "<tr id='" + i + "'>" +
                ...
                "   <td style='padding: 3px;'><input type='number' name='evening[]' min='0' value='1' style='text-align: center' class='form-control'/></td>" +
                "   <td style='padding: 3px;'><input type='number' name='duration[]' min='0' value='3' style='text-align: center' class='form-control'/></td>" +
                "   <td style='padding: 3px;text-align:center'><button type='button' onClick='onDelete("+i+");' class='btn btn-danger'><span class='tf-icons bx bx-trash'/></button></td>" +
                "</tr>";
