...
>
  <head>
    <?php 
      if ($lang == 1) {
        ...
        $page_title = 'Manual Count Stock List';
        $text_btn_create = 'Make Manual Close Stock';
  ...
  <foot>
    ...
    <script src="script/stock_manual_count_list.js"></script>
    <script type="text/javascript">
      window.onload = function(){
          var activeMenu = document.getElementById("Inventory");
          activeMenu.classList.add("open");
          activeMenu.classList.add("active");
          var activeSubMenu = document.getElementById("sub-Stock Count");
