...
>
  <head>
    <?php 
      if ($lang == 1) {
        ...
        $page_title = 'Pending invoices report';
        $th2 = 'Amount';
        $th3 = 'Patient Info';
        $th4 = 'Invoice No';
        $th5 = 'Dentist';
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                <?php include_once('../inc/report_pending_payment_menu.php'); ?> 
              <!-- Table -->
                <div class="card-body">
  ...
  <foot>
    ...
    <script src="../script/page_report_pending_invoice.js"></script>
    <script type="text/javascript">
      window.onload = function(){
        var activeMenu = document.getElementById("Analytics");
        activeMenu.classList.add("open");
        activeMenu.classList.add("active");
        var activeSubMenu = document.getElementById("sub-Pending Invoice Report");
