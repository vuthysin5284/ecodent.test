...
>
  <head>
    <?php 
      if ($lang == 1) {
        ...
        $page_title = 'ប្រភេទរូបភាព';
        $text_btn_create = 'បង្កើតថ្មី';
        $text_form = 'ប្រភេទរូបភាព';
        $m1 = 'ចំណងជើង';
        $th2 = 'ចំណងជើង';
        $th3 = 'បង្កើតដោយ';
        $th4 = 'ដំណើរការ';
                      ...
                      <form class="modal-content" id="addForm" method="POST" enctype="multipart/form-data"> 
                        ...
                        <div class="modal-body">
                          <div class="row mb-3"> 
                            ...
                            <?php echo inpText($m1, 'title', 'Panoramic X-Ray'); ?>
                          </div>
                        </div>
  ...
  <foot>
    ...
    <script src="../script/page_patient_files.js"></script>
    <script type="text/javascript">
      window.onload = function(){
        ...
        var activeTabMenu = document.getElementById("patient-gallary");
