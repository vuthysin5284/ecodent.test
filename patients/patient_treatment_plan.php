...
>
  <head>
    <?php 
      if ($lang == 1) {
        ...
        $text_btn_create = 'Make Serving';
        $text_form_apt= 'Appointment Information';
        $text_form = 'Treatment Plan';
  ...
  <body>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">   
              ...
              <div class="card">     
                ...
                <div class="card-body p-3">   
                  ...
                  <!-- Reschedule -->
                  <div class="modal fade" id="ModalReschedule" data-bs-backdrop="static" tabindex="-1">
                    <div class="modal-dialog">
                      <form class="modal-content" id="addForm" method="POST" enctype="multipart/form-data"> 
                        <div class="modal-header">
                          <h5 class="modal-title" id="backDropModalTitle">Re-Schedule Appointment</h5>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                          <div class="row mb-3"> 
                            <?php echo inpHidden('id', '2'); ?>
                            <?php echo inpText($m1, 'title', 'Orthodontics'); ?>
                          </div>
                        </div>
                  ...
                  <!-- Visit plan -->
                  <div class="modal fade" id="ModalVisitPlan" data-bs-backdrop="static" tabindex="-1">
                    <div class="modal-dialog">
                      <form class="modal-content" id="addForm" method="POST" enctype="multipart/form-data"> 
                        <div class="modal-header">
                          <h5 class="modal-title" id="backDropModalTitle">Visit Plan</h5>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                          <div class="row mb-3"> 
                    ...
                    <table class="table table-bordered" id="dataTable">
                      <thead class="text-nowrap">
                        <tr>
                          ...
                          <th class="text-right w-50"><?php echo $th3; ?></th>
    ...
    <script src="../script/page_patient_treatment_plan.js"></script>
