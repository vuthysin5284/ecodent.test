...
>
  <head>
    <?php 
      if ($lang == 1) {
        ...
        $page_title = 'កញ្ចប់សមាជិក';
        $text_btn_create = 'បង្កើតថ្មី';
        $text_form = 'កញ្ចប់សមាជិក';
        $m1 = 'លេខកូដ';
        $m2 = 'កញ្ចប់សមាជិក';
        $m3 = 'បញ្ចុះតម្លៃ (%)';
        $th2 = 'កញ្ចប់សមាជិក';
                ...
                <div class="modal-dialog">
                  <form class="modal-content" id="addForm" method="POST" enctype="multipart/form-data"> 
                    ...
                    <div class="modal-body">
                      ...
                      <div class="row mb-3"><?php echo inpText($m2, 'membership', 'Ex: Gold Member'); ?></div>
                      <div class="row mb-3"><?php echo inpText($m3, 'discount', 'Ex: 10'); ?></div>
                    </div>
  ...
  <foot>
    ...
    <script src="../script/page_membership.js"></script>
